package shiv.raj.admin.sideicon.AboutActivity;
...
public class AboutPage extends Activity {
    ...
    public AboutPage(Context context){this.mContext = context;
    ...
    */
    public AboutPage addWebsite(String url) {
        ...
        websiteElement.setTitle(mContext.getString(R.string.patreon));
